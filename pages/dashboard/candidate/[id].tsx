      ...
      <div className="grid grid-cols-6 mt-10 ">
        <div className="col-span-4 flex flex-col ">
          ...
          {interviews.map((interview) => (
            <div
              key={interview._id}
              className="bg-white rounded-lg shadow-lg mt-4 mr-4 p-3 flex flex-col border border-gray-300 "
            >
              <div className=" flex justify-between items-center">
                ...
                <InfoItem
                  label="Status"
                  value={interview.completed ? "Completed" : "Pending"}
                />
                <InfoItem
                  label="Completion Date"
                  value={moment(interview.completedUtc).format("DD/MM/YYYY")}
                />
              </div>
              <div className="p-1">
                ...
                {interview.tasks.map((task) => (
                  <div
                    key={task._id}
                    className="grid grid-cols-2 items-center justify-center border-b border-gray-300  pt-3 pb-3"
                  >
                              ...
                              >
                                ...
                                <div className="flex justify-center items-center ">
                                  <div className="flex justify-center items-center w-5 h-5">
                                    {task?.answer?.includes(choice.value) ? (

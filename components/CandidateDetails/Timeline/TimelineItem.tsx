      ...
      {comment !== true ? (
        <div className="flex mb-1 ">
          <div className="w-14 flex flex-col justify-center items-center ">
            <div>
              {" "}
              {Icon && <Icon className={`h-6 w-6 text-${color}-500`} />}
            </div>
            {show !== true ? (
          ...
          <div className="flex justify-between w-full ml-1  ">
            <div className="text-sm text-gray-500 flex">
              {`${helpText}`}{" "}
              <p className="ml-1 font-bold text-gray-700">{`${position}`}</p>
            </div>
            <div>
              <p className="text-sm  font-semibold text-gray-500 pr-1">
                {date}
              </p>
            </div>
          </div>
        ...
        <div className="flex mb-1">
          <div className="w-14 flex flex-col items-center">
            <div className="h-10 w-10 text-gray-500 rounded-full bg-gray-200 p-1 items-center flex flex-col justify-center mt-1">
              <p className="font-semibold">
                {stringAvatar(`${candidate?.firstName} ${candidate?.lastName}`)}
              </p>
              <div className="absolute mt-12 ml-10">
                {" "}
                {Icon && (
                  <Icon className="h-6 w-6 text-gray-400 bg-white mb-3" />
                )}
              </div>
            </div>
